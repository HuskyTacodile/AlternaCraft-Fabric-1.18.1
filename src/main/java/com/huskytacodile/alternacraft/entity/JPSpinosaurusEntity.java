...
public class JPSpinosaurusEntity extends TameableEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(JPSpinosaurusEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public JPSpinosaurusEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    private static final TrackedData<Boolean> SITTING =
            DataTracker.registerData(JPSpinosaurusEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public void setTamed(boolean tamed) {
        ...
        if (tamed) {
            getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(105.0D);
